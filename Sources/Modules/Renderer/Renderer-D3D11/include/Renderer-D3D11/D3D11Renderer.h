...
namespace ZED
{
	...
	private:
		...
		float4x4 MakePerspective(float fovyRadians, float aspect, float znear, float zfar);
		float4x4 MakeRotationY(float angle);
		float4x4 MakeTranslation(float x, float y, float z);
